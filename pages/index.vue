  ...
  <div>
    <div class="flex flex-col justify-center items-center mt-5 relative">
      ...
      <div id="video" class="w-full px-[10vw] md:px-[14vw] lg:px-[20vw] xl:px-[30vw] mt-10 md:mt-10">
        <div class="w-full aspect-video bg-black-100 flex items-center justify-center"><span class="text-black-default text-xl">Video ist noch nicht verfügbar!</span></div>
        <!--
        <video
      ...
      <div
        ...
        <div
          ...
          <p class="text-base">In der Medientechnik lernst du die Produktion verschiedenster Medien, die Bearbeitung von...</p>
          <div class="flex justify-center mt-auto">
            <button
      ...
      <div id="quiz"
        ...
        <div class="border-2 border-guideit-default bg-guideit-100 px-4 py-2 rounded-xl shadow-guideit-200 shadow-md">
          <h2 class="text-guideit-800 text-2xl text-center">DAS QUIZ</h2>
          <p class="text-center text-base">Finde jetzt heraus, welche Fachrichtung am besten zu dir passt!</p>
